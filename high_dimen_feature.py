...
# 11, 13, 43
parser.add_argument('--save_name', type=str, default="./high_feature_train.mat")
...
parser.add_argument('--exclude_file', type=str, default="./data/casia_10_landmark.txt")
...
if args.exclude is True:
    with open(args.exclude_file) as f:
        ...
        print("exclude list:", len(exclude_list))
exclude_num = 0
...
for i in range(batch_num):
    ...
    for j in range(args.batch_size):
        ...
        bullshit = i*args.batch_size + j
        if bullshit > len(landmark_lines):
            break
        line = landmark_lines[bullshit]
        
        if line in exclude_list:
            print("exclude!", exclude_num)
            exclude_num += 1
            continue
